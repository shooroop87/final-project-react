...
export const MoreSquareSVG: FC<SVGType> = ({ color = 'var(--text-redesigned)', size = 24 }) => (
  <svg
  ...
  >
    ...
    <path
      fill={color}
      d='M12 12.93a.927.927 0 0 1-.93-.93c0-.512.418-.93.93-.93s.93.418.93.93-.409.93-.93.93m3.72 0a.927.927 0 0 1-.93-.93c0-.512.42-.93.93-.93.512 0 .931.418.931.93s-.41.93-.93.93m-7.442 0a.927.927 0 0 1-.93-.93c0-.512.418-.93.93-.93.511 0 .93.418.93.93s-.41.93-.93.93'
    />
  </svg>
);
